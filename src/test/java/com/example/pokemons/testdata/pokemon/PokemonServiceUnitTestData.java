...
public class PokemonServiceUnitTestData {
    ...
    private static final String NULL_OR_BLANK_ERROR = "Name should not be null or blank";
    private static final String MAX_OR_LESS_ERROR = "Power should not be greater than 100.00 and less than 0.00";
    private static final String CAPITAL_ERROR = "Name only first character should be capital, rest should be lowercase";
    ...
    public static Stream<Arguments> invalidPokemonData() {
        return Stream.of(
                Arguments.of(null, new BigDecimal("50.00"), null, WATER_TYPE, NULL_OR_BLANK_ERROR),
                Arguments.of("", new BigDecimal("90.00"), null, WATER_TYPE, NULL_OR_BLANK_ERROR),
                Arguments.of("           ", new BigDecimal("90.00"), null, WATER_TYPE, NULL_OR_BLANK_ERROR),
                Arguments.of("a".repeat(100), new BigDecimal("56.00"), null, WATER_TYPE, CAPITAL_ERROR),
                Arguments.of("A" + "b".repeat(100), new BigDecimal("56.00"), null, WATER_TYPE, "Name length should not be greater than 100 signs"),
                Arguments.of("A".repeat(100), new BigDecimal("56.00"), null, WATER_TYPE, CAPITAL_ERROR),
                Arguments.of("Pikachu", new BigDecimal("100.01"), "Kind pokemon", ELECTRIC_TYPE, MAX_OR_LESS_ERROR),
                Arguments.of("Pikachu", new BigDecimal("100.005"), "Kind pokemon", ELECTRIC_TYPE, MAX_OR_LESS_ERROR),
                Arguments.of("Pikachu", new BigDecimal("-0.01"), "Kind pokemon", ELECTRIC_TYPE, MAX_OR_LESS_ERROR),
                Arguments.of("Pikachu", new BigDecimal("-0.001"), "Kind pokemon", ELECTRIC_TYPE, MAX_OR_LESS_ERROR),
